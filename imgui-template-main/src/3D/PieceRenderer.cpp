...
void PieceRenderer::draw(const ChessBoard& board, const glm::mat4& mvp,
        ...
        for (int col = 0; col < 8; ++col)
        {
            ...
            glm::mat4 model = glm::translate(glm::mat4(1.f), piecePos)
                            ...
                            * glm::translate(glm::mat4(1.f),
                                glm::vec3(-bboxCenter.x, -mesh.bboxMin.y, -bboxCenter.z));
